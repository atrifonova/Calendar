 ...
 */
public class RobotoCalendarView
	extends LinearLayout
{
	...
	public void markDayAsCurrentDay(Date currentDate)
	{
		...
		Typeface robotoTypeface = RobotoTypefaceManager.obtaintTypefaceFromString(context,
				getResources().getString(R.string.currentDayOfMonthFont));
